          ...
          <div className="flex">
            <div className="w-1/3 border-b-2 border-white px-10 py-4 my-2 basis-1/3">
              ...
              <div className='m-2 lg:w-full'>
                <p className="text-center h-10 w-10 text-base lg:h-48 lg:w-48 lg:text-6xl rounded-full ring-offset-1 ring-1 ring-white bg-slate-700 p-2 lg:p-12 my-2 cursor-pointer">{studentInformation.email && studentInformation.email.charAt(0).toUpperCase()}</p>
                <div className='w-24 text-sm break-words lg:w-full lg:text-xl lg:font-bold'>{studentInformation.email}</div>
              </div>
            </div>
            {/* Profile Detail */}
            <div className="border-l-2 border-b-2 rounded-bl-lg border-white mx-4 basis-3/4">
              ...
              <div className='text-md lg:text-2xl  m-4'>{studentInformation.firstName+" "+ studentInformation.lastName}</div>
              <div className='text-xl lg:text-4xl m-4'>Phone</div>
              <div className='text-md lg:text-2xl  m-4'>{studentInformation.phone}</div>
              <div className='text-md lg:text-4xl m-4'>No. Of Certificates Issued</div>
              <div className='text-xl lg:text-2xl  m-4'>{certificateDetails.length}</div>             
            </div>
          </div>
