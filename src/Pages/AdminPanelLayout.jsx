    ...
    <>
        ...
        <div className='h-[80rem] basis-1/6 md:basis-1/4 bg-slate-700  divide-y-2 divide-slate-400'>
            ...
            <div className="brand my-6">
                <Link className="lg:flex title-font font-medium items-center max-md:mx-auto text-white mb-4 md:mb-0  " to='/admins-panel'>
            ...
            <div className='p-2 hover:bg-slate-800 cursor-pointer'>
                <Link to={"/admins-panel/users"} className="text-white text-2xl ">Users</Link>
            </div>
            <div className='p-2 hover:bg-slate-800 cursor-pointer'>
