...
export default function Content() {
  const beauticianCourseImg = [
    '/Beautician Slide 1.jpg',
    '/mehendi 1.jpg',
    '/Beautician Slide 2.jpg',
    '/sewing image.jpg',
    '/nail-art-1.jpg',
  ];
  ...
  const courses = [
    ...
    },
    {
      ...
      description:
        "Discover the art of sewing with our silai course! From understanding different types of fabrics to mastering essential stitching techniques, our experienced instructors will guide you through every step of the sewing process. Whether you're passionate about fashion design or simply want to create your own wardrobe.",
      price: 'Rs.1200',
    },
    {
      ...
      <section className="text-gray-400 body-font bg-gray-900">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-lg text-gray-400 text-opacity-90">
              Welcome to Varsha Mekup Studio, where passion meets profession!
              Our center offers expert-led courses in Makeup, Beautician, Nail
              Art, Mehendi, and Silai (sewing), providing hands-on training and
              personalized instruction. Join us to unleash your creativity and
              embark on a journey of skill-building and self-expression!
            </p>
          </div>
              ...
              {courses.map((course, index) => (
                <div key={course.name} className="w-full p-4">
                  <div className="bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                    ...
                    <a href="#contactUs">
                      <div className="bg-indigo-500 rounded text-lg w-1/4 p-2 my-2 hover:bg-indigo-600 cursor-pointer text-white">
                        Buy Now
                      </div>
                    </a>
                  </div>
