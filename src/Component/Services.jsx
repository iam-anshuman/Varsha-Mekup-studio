        ...
        <div className="container px-5 py-28 mx-auto">
          <div className="flex flex-wrap w-full mb-20">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-lg text-gray-400 text-opacity-90">
              Welcome to Varsha Mekup Studio! We're here to make you look and
              feel amazing. Whether you're in need of a relaxing facial, a
              stylish haircut, or a perfect manicure, our talented team has got
              you covered. Sit back, relax, and let us take care of all your
              beauty needs. Book your appointment now for a pampering experience
              like no other!
            </p>
          </div>
          <div className="grid md:grid-cols-4 sm:grid-cols-1 w-full mx-auto mt-4">
            <div className="bg-slate-700 text-3xl  text-center text-white py-28">
              ...
              <div
                className="text-xl cursor-pointer hover:text-gray-300 my-2"
                onClick={openModal}
              >
                Book Now &gt;
              </div>
            ...
            <div className=" text-white hover:scale-110 cursor-pointer ease-out duration-500">
              <img src="/bridal-makeup.jpg" alt="Bridal Makeup" />
            </div>
            ...
            <div className=" text-white hover:scale-110 cursor-pointer ease-out duration-500">
              <img src="/Hair-style.jpg" alt="HairStyle" />
            </div>
            <div className="bg-slate-600 text-3xl  text-center text-white py-28">
              <div className="bg-slate-100 h-1 rounded w-1/4 mx-auto my-5"></div>
