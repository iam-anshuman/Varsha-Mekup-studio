...
export default function Header() {
  ...
  const styleClass = clsx(`lg:hidden w-full h-full md:h-3/6 top-0 bg-slate-700 rounded z-20  my-2 duration-300 ease-in-out ${isOPen?'absolute translate-x-0':' absolute translate-x-[100vw]'}`);
...
<header className="text-gray-400 bg-gray-800 body-font ">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center max-md:items-start ">
    ...
    <div className='sm:block lg:hidden w-20 absolute top-10 right-1' onClick={handleOpenDrawer}>
