...
export default function Header() {
  ...
  const styleClass = clsx(`lg:hidden w-full h-full md:h-3/6 top-0 bg-slate-700 rounded z-10  my-2 duration-300 ease-in-out ${isOPen?'absolute translate-x-0':' absolute translate-x-[100vw]'}`);
...
<header className="text-gray-400 bg-gray-800 body-font ">
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center max-md:items-start ">
    ...
    <div className='sm:block lg:hidden w-20 absolute top-5 right-1' onClick={handleOpenDrawer}>
    ...
    <nav className="md:ml-auto md:mr-auto lg:flex flex-wrap max-lg:hidden items-center text-base justify-center">
      <Link className="mr-5 cursor-pointer text-xl hover:text-white " to='/'>Home</Link>
      <a className="mr-5 cursor-pointer text-xl hover:text-white " href='#services'>Services</a>
    ...
    <div className='sm:block lg:hidden w-20 absolute top-5 left-3/4' onClick={handleCloseDrawer}>
      ...
      <Link className="mr-5 block cursor-pointer text-xl mx-6 my-10 hover:text-white " to='/'>Home</Link>
      <a className="mr-5 block cursor-pointer text-xl mx-6 my-10 hover:text-white " href='#services'>Services</a>
      ...
      <div >
      <Link to={"/signup"}>
      <button className="inline-flex mx-4 items-center  py-2 px-3 text-xl hover:bg-gray-700 rounded  mt-4 md:mt-0">Sign Up
      <svg width="25" height="25" viewBox="0 0 15 15" fill="none" className='mx-2' xmlns="http://www.w3.org/2000/svg">
        <path d="M7.4986 0C6.3257 0 5.36107 0.38943 4.73753 1.19361C4.23745 1.83856 4 2.68242 4 3.63325H5C5 2.84313 5.19691 2.23312 5.5278 1.80636C5.91615 1.30552 6.55152 1 7.4986 1C8.35683 1 8.96336 1.26502 9.35846 1.68623C9.75793 2.11211 10 2.76044 10 3.63601V6H3C2.44772 6 2 6.44772 2 7V13C2 13.5523 2.44772 14 3 14H12C12.5523 14 13 13.5523 13 13V7C13 6.44771 12.5523 6 12 6H11V3.63601C11 2.58135 10.7065 1.66167 10.0878 1.0021C9.46477 0.337871 8.57061 0 7.4986 0ZM3 7H12V13H3V7Z" fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"></path>
        </svg>
      </button>
      </Link>
      <Link to={"/login"}>
      <button className="inline-flex items-center text-xl text-white bg-indigo-500 border-0 py-2 px-3 focus:outline-none hover:bg-indigo-600 rounded  mt-4 md:mt-0">Login
