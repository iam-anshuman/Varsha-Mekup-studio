                      ...
                      <form onSubmit={handleSignupUser}>
                        <div className="relative flex">
                          <div className=" relative w-1/2">
                            <input
                              ...
                              name="firstName"
                              type="text"
                              className="peer placeholder-transparent h-10 my-4 w-3/4 border-b-2 bg-slate-700 border-slate-950 text-gray-200 focus:outline-none focus:borer-rose-600"
                              placeholder="First Name"
                            />
                            <label
                              htmlFor="firstName"
                              className="absolute left-0 text-white text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-200 peer-focus:text-sm"
                            >
                              First Name
                            </label>
                          </div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            name="phone"
                            type="number"
                            className="peer placeholder-transparent h-10 w-full my-4 border-b-2 bg-slate-700 border-slate-950 text-gray-200 focus:outline-none focus:borer-rose-600"
                        ...
                        <div className="relative">
                          <input
                            ...
                            name="password"
                            type="password"
                            className="peer placeholder-transparent my-4 h-10 w-full bg-slate-700 border-b-2 border-slate-950 text-gray-200 focus:outline-none focus:borer-rose-600"
